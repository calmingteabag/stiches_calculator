...
class StichesCalculator:
    ...
    def get_data(self):
        ...
        For example, it should count near values (255,255,255) and 
        (245,250,235) as 'white'
        """

        for rgb_triplets in img_data:
            if rgb_triplets[0] == 255 and rgb_triplets[1] == 255:
                print("white")
...
b = StichesCalculator('ganyu.jpg', 5, 'RGB', 'ascii_image.txt')
# b.process()
print(b.get_data())
